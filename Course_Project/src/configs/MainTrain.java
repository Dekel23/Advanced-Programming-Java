...
public class MainTrain {
    ...
    public static void main(String[] args) {
        ...
        String file = "C:/Users/ereld/OneDrive/Documents/Erel_Studies/BIU - BEng Computer Engineering & Physics/year4/second/Advanced Programming - 83677/Project_Code/config_files/simple.conf";
        gc.setConfFile(file); // change to the exact loaction where you put the file.
        gc.create();
